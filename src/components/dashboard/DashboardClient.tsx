...
// ── Panneau Notes / to-do (privé par utilisateur) ──────────────────────────
// Primitives LOCALES du dashboard (Card/CardHeader/Badge/Row). État local seedé
// depuis les notes initiales ; mutations via /api/notes avec maj OPTIMISTE (pas
// de router.refresh par coche). Faits = barrés + atténués, triés SOUS les non-faits.
function NotesPanel({ notesInitiales, projets }: { notesInitiales: any[]; projets: any[] }) {
